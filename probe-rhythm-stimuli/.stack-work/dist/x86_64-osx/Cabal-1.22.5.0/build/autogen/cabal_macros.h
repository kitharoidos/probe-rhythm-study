...
/* package csound-catalog-0.5.0 */
#define VERSION_csound_catalog "0.5.0"
#define MIN_VERSION_csound_catalog(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  5 || \
  (major1) == 0 && (major2) == 5 && (minor) <= 0)

/* package csound-expression-5.0.1 */
#define VERSION_csound_expression "5.0.1"
...
/* package temporal-music-notation-0.4.1 */
#define VERSION_temporal_music_notation "0.4.1"
#define MIN_VERSION_temporal_music_notation(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  4 || \
...
#define CURRENT_PACKAGE_KEY "probe_GhpfxM5TCHW90UKWP1Xo7K"
