...
polyRhythms = frame 1 . centerXY $ vsep 4 allOscs
  where pbs = [[], [(red, 2)], [(red, 1)]]
        ...
        eqtOscs' = beside' (-unitY) (centerX (text "12TET") ||| strutY 2) (head eqtOscs) : tail eqtOscs
        farOscs' = beside' (-unitY) (centerX (text "Farey") ||| strutY 2) (head farOscs) : tail farOscs
